      ...
      .then(() => {
        ...
        return knex('companies').insert([
          ...
          },
          {
            ...
            field: 'Cybersecurity',
            location: 'North Island - North',
            description: 'ShieldGuard Cybersecurity provides top-notch cybersecurity solutions, ensuring that businesses digital assets and sensitive information are protected from cyber threats. Their comprehensive security strategies, advanced threat detection systems, and proactive incident response capabilities help businesses safeguard their networks, systems, and data from evolving cyber risks.',
            vacancies: false,
          },
          {
            id: 8,
          ...
          },
          {
            ...
            location: 'North Island - South',
            description: 'NetConnect Solutions is a network engineering company that designs and implements reliable and scalable network infrastructure solutions. Their team of skilled engineers ensures seamless connectivity, optimal performance, and enhanced network security, empowering businesses to efficiently communicate, collaborate, and access critical resources.',
            vacancies: false,
          },
          {
            id: 11,
            ...
            field: 'Network Engineering',
            location: 'South Island - South',
            description: 'LinkTech Networks is a trusted provider of networking solutions, delivering high-performance network architectures and robust connectivity options. Their expertise in network design, configuration, and optimization enables businesses to achieve seamless connectivity, efficient data transfer, and secure network operations.',
            vacancies: false,
          },
          {
            id: 12,
          ...
          },
          {
            ...
            field: 'Cloud Computing',
            location: 'South Island - North',
            description: 'CloudSphere Innovations specializes in providing innovative cloud solutions that enable businesses to streamline their operations and maximize their productivity. With their comprehensive suite of cloud services, including cloud migration, infrastructure optimization, and workload management, they empower businesses to harness the full potential of cloud computing and stay ahead in a competitive digital landscape.',
            vacancies: false,
          },
          {
            id: 16,
