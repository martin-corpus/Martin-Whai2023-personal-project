...
if (process.env.NODE_ENV === 'production') {
    server.use('/assets', express_1.default.static((0, node_path_1.resolve)(__dirname, '../../assets')));
    server.use('/images', express_1.default.static((0, node_path_1.resolve)(__dirname, '../../images')));
    server.get('*', (req, res) => {
        res.sendFile((0, node_path_1.resolve)(__dirname, '../../index.html'));
    });
}
